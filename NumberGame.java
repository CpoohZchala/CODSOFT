...
public class NumberGame {
    public static void main(String[] args) {
        ...
        while (playAgain) {
            rounds++;
            totalAttempts += numberGame(minNum, maxNum, maxAttempts, random, scanner);
    ...
    public static int numberGame(int minNum, int maxNum, int maxAttempts, Random random, Scanner scanner) {
